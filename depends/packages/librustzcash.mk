...
define $(package)_stage_cmds
  ...
  cp target/release/librustdwcash.a $($(package)_staging_dir)$(host_prefix)/lib/ && \
  cp include/librustdwcash.h $($(package)_staging_dir)$(host_prefix)/include/
endef
