...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to dwcashd by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for dwcashd -help.
...
Jay Graber (5):
      ...
      Add security warning to dwcash-cli --help and --version message output
      Add security warning to dwcashd metrics display
...
Sean Bowe (2):
      Introduce librustdwcash and Rust to depends system.
