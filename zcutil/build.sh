...
$0 [ --enable-lcov || --disable-tests ] [ --disable-mining ] [ --disable-rust ] [ --disable-proton ] [ MAKEARGS... ]
  ...
  If --disable-mining is passed, DeepWebCash is configured to not build any mining
  code. It must be passed after the test arguments, if present.

  If --disable-rust is passed, DeepWebCash is configured to not build any Rust language
  assets. It must be passed after mining/test arguments, if present.

  If --disable-proton is passed, DeepWebCash is configured to not build the Apache
