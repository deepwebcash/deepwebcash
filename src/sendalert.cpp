...
./dwcashd -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.nID           = 1001;  // use https://github.com/deepwebcash/deepwebcash/wiki/specification#assigned-numbers to keep track of alert IDs
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and potentially vulnerable to denial of service. Please update to the most recent version of DeepWebCash (1.0.5). More info at: https://dw.cash/support/security.html";
    alert.strRPCError   = "Your client is out of date and potentially vulnerable to denial of service. Please update to the most recent version of DeepWebCash (1.0.5). More info at: https://dw.cash/support/security.html";
